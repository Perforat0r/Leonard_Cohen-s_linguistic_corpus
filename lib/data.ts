...
export const albums: Album[] = [
    ...
    tracks: [
      {
        ...
        wordCount: 312,
        uniqueWords: 156,
        lyrics: `Well I stepped into an avalanche,
      ...
      },
      {
        ...
        wordCount: 267,
        uniqueWords: 128,
        lyrics: `(Let's sing another song, boys, this one has grown old and bitter.)
    ...
    tracks: [
      {
        ...
        wordCount: 245,
        uniqueWords: 128,
        lyrics: `You were the promise at dawn,
      ...
      },
      {
        ...
        wordCount: 156,
        uniqueWords: 78,
        lyrics: `And who by fire, who by water,
      ...
      },
      {
        ...
        wordCount: 147,
        uniqueWords: 82,
        lyrics: `Alas, my love, you did me wrong,
    ...
    tracks: [
      {
        ...
        wordCount: 198,
        uniqueWords: 102,
        lyrics: `As the mist leaves no scar
      ...
      },
      {
        ...
        wordCount: 287,
        uniqueWords: 142,
        lyrics: `I was born in a beauty salon
      ...
      },
      {
        ...
        wordCount: 234,
        uniqueWords: 118,
        lyrics: `I touched you once too often
      ...
      },
      {
        ...
        wordCount: 485,
        uniqueWords: 198,
        lyrics: `Ah the man she wanted all her life was hanging by a thread
    ...
    tracks: [
      {
        ...
        wordCount: 312,
        uniqueWords: 156,
        lyrics: `One by one, the guests arrive
      ...
      },
      {
        ...
        wordCount: 298,
        uniqueWords: 145,
        lyrics: `Why do you stand by the window
      ...
      },
      {
        ...
        wordCount: 234,
        uniqueWords: 118,
        lyrics: `I came so far for beauty
  ...
  },
  {
    ...
    tracks: [
      ...
      },
      {
        ...
        wordCount: 267,
        uniqueWords: 134,
        lyrics: `How many times did you call me
      ...
      },
      {
        ...
        wordCount: 178,
        uniqueWords: 92,
        lyrics: `Your father's gone a-hunting
      ...
      {
        //
        id: "heart-no-companion",
        title: "Heart With No Companion",
        duration: "3:00",
        wordCount: 208,
        uniqueWords: 92,
        lyrics: `I greet you from the other side
    ...
    tracks: [
      {
        ...
        wordCount: 456,
        uniqueWords: 198,
        lyrics: `Give me back my broken night
      ...
      },
      {
        ...
        wordCount: 298,
        uniqueWords: 145,
        lyrics: `She stands before you naked
      ...
      },
      {
        ...
        wordCount: 145,
        uniqueWords: 78,
        lyrics: `(Oh friends, .. don't matter if you're a man or a woman. If you're in love
  ...
  },
  {
    ...
    tracks: [
      ...
      },
      {
        ...
        wordCount: 267,
        uniqueWords: 128,
        lyrics: `O Crown of Light, O Darkened One,
    ...
    tracks: [
      {
        ...
        wordCount: 134,
        uniqueWords: 72,
        lyrics: `So we'll go no more a-roving
      ...
      },
      {
        ...
        lyrics:
          ...
          Is it censorship? Is it censorship? No, it's evaporation. No, it's evaporation. Is this leading somewhere? 
          Yes. We're going down the lane. Is this going somewhere? Into the garden. Into the backyard. 
          We're walking down the driveway. Are we moving towards.... We're in the backyard. ...some transcendental moment? 
          It's almost light. That's right. That's it. Are we moving towards some transcendental moment? 
          That's right. That's it. Do you think you'll be able to pull it off? Yes. Do you think you can pull it off? 
      ...
      },
      {
        ...
        wordCount: 198,
        uniqueWords: 98,
        lyrics: `I built my house beside the wood
      ...
      },
      {
        ...
        wordCount: 122,
        uniqueWords: 67,
        lyrics: `The sea so deep and blind
            ...
            {
        id: "tennesee",
        title: "Tennessee Waltz (live)",
        duration: "4:05",
        wordCount: 141,
        uniqueWords: 70,
        lyrics: `I was dancing with my darlin'
  ...
  },
  {
    ...
    tracks: [
      ...
      {
        id: "string-reprise",
        title: "String Reprise/Treaty",
        duration: "1:54",
        wordCount: 20,
        uniqueWords: 12,
        lyrics: `I wish there was a treaty we could sign
                It's over now, the water and the wine
                We were broken then but now we're borderline
  ...
  {
    id: "thanks-for-the-dance",
    title: "Thanks for the Dance",
    year: 2019,
    trackCount: 9,
    totalWords: 1563,
    uniqueWords: 582,
    avgWordsPerSong: 173.7,
    tracks: [
      {
        id: "happens-to-the-heart",
...
export const corpusStats = {
  ...
  totalWords: 35139,
  uniqueWords: 3524,
  avgWordsPerAlbum: 2381,
  avgWordsPerTrack: 253,
  careerSpan: "1967-2019",
  mostProductiveDecade: "1970s",
}

export const wordCloudData = [
  { word: "love", count: 847, size: 48 },
  { word: "night", count: 423, size: 38 },
  { word: "time", count: 398, size: 36 },
  { word: "heart", count: 356, size: 34 },
  { word: "soul", count: 312, size: 32 },
  { word: "light", count: 287, size: 30 },
  { word: "dark", count: 267, size: 28 },
  { word: "sing", count: 256, size: 27 },
  { word: "woman", count: 234, size: 26 },
  { word: "man", count: 223, size: 25 },
  { word: "song", count: 212, size: 24 },
  { word: "dance", count: 198, size: 23 },
  { word: "rain", count: 187, size: 22 },
  { word: "fire", count: 178, size: 21 },
  { word: "water", count: 167, size: 20 },
  { word: "God", count: 156, size: 19 },
  { word: "broken", count: 145, size: 18 },
  { word: "beauty", count: 134, size: 17 },
  { word: "truth", count: 128, size: 16 },
  { word: "desire", count: 118, size: 15 },
  { word: "freedom", count: 112, size: 14 },
  { word: "mercy", count: 98, size: 13 },
  { word: "stranger", count: 92, size: 12 },
  { word: "waiting", count: 87, size: 12 },
  { word: "silence", count: 82, size: 11 },
  { word: "prayer", count: 78, size: 11 },
  { word: "morning", count: 76, size: 10 },
  { word: "evening", count: 72, size: 10 },
  { word: "war", count: 68, size: 9 },
  { word: "peace", count: 64, size: 9 },
]

export const comparisonData1967 = {
  ...
  topThemes: ["любовь", "духовность", "потеря", "желание"],
  dominantMood: "Меланхоличное/Романтичное",
  poeticDevices: ["метафора", "образность", "повторение"],
}

export const comparisonData2019 = {
  ...
  uniqueWords: 582,
  avgWordsPerSong: 173.7,
  lexicalDensity: 0.372,
  avgSentenceLength: 7.8,
  topThemes: ["смертность", "вера", "принятие", "наследие"],
  dominantMood: "Созерцательное/Смиренное",
  poeticDevices: ["символизм", "библейская аллюзия", "парадокс"],
}
